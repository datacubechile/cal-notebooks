...
def frac_coverage_classify(dataset_in, clean_mask=None, no_data=-9999):
    ...
    **Landsat 8 Collection 2 Level 2 (surface reflectance) data must be used.**
    ...
    # TEMPORARY MODIFICATION to handle 'x' and 'y' instead of just 'latitude' and 'longitude'
    # import odc.geo.xr
    # y_dim, x_dim = dataset_in.odc.spatial_dims
    # latitude = dataset_in[y_dim]
    # longitude = dataset_in[x_dim]
